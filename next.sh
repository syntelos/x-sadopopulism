...
Description
    ...
    Formulate subsequent filename with default filename extension
    'tex'.
    ...
    Filename extension
        ...
        Formulate subsequent filename with argument filename extension
        in
    ...
    Parameters
        ...
        Formulate subsequent filename with argument filename <prefix>
        in
        ...
        Formulate subsequent filename with argument filename <date> in
        ...
        Formulate subsequent filename with argument filename
        <subtitle> in
        ...
        Formulate subsequent filename with argument filename <index>
        in
